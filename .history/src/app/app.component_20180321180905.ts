...
import { GisViewerProps, TileLayerDefinition, ShapeLayerDefinition,
   ...
   UnitsChangerOptions, MapConfig, LayerManagerConfig, ScaleConfig, SearchConfig, MiniMapConfig, DrawBarConfig, MouseCoordinateConfig, MeasureConfig} from 'gis-viewer/dist/types/models/apiModels';
