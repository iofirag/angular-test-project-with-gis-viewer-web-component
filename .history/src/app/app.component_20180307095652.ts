...
import { GisViewerProps, MapSettings, TileLayerDefinition, ShapeLayerDefinition, LayersControllerOptions, ScaleControlOptions, SearchBoxOptions, MiniMapOptions, ZoomControl, DrawBarOptions, MouseCoordinateOptions} from 'gis-viewer/dist/types/models/apiModels';
