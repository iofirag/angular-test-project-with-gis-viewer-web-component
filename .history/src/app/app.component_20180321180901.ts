...
import { GisViewerProps, TileLayerDefinition, ShapeLayerDefinition,
   ...
   UnitsChangerOptions, MapConfig, LayerManagerConfig, ScaleConfig, SearchConfig, MiniMapConfig, DrawBarConfig, MouseCoordinateConfig} from 'gis-viewer/dist/types/models/apiModels';
